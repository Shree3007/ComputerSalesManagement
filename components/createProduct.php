...
// Fetching supplier IDs from the supplier table
$supplierIds = [];
$sqlSupplier = "SELECT sup_id FROM supplier";
    ...
    <div class="container my-5"> 
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <select class="form-select" name="sup_id">
                        <option value="">Select Supplier ID</option>
                        <?php foreach ($supplierIds as $supplierId) : ?>
